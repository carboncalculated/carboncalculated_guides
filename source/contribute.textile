...
<plain>
$ git clone git://github.com/<yourname>/carboncalculated_guides.git
</plain>
...
The easiest way to get started with the guides on OSX is to download and install the "guides pkg":http://.pkg. This will give you the +guides+ executable on your machine, and does not require you to have a C compiler on your computer.
...
* Twitter: "@carbonhq":http://twitter.com/#!/carbonhq
* Email : support@carboncalculated.com
